...
**Claude Code requires Anthropic API access.** It does NOT support:
- Ollama Cloud endpoints (kimi-k2.5, qwen3, etc.)
- Local LLM servers (llama.cpp, vLLM, etc.)
- OpenAI-compatible endpoints

**For Ollama Cloud users:** Use `opencode` skill instead — OpenCode CLI supports OpenAI-compatible endpoints including Ollama Cloud.
